package com.biacoelho.crudcliente.resources;
...
import com.biacoelho.crudcliente.services.CustomerService;
...
public class CustomerResource {
	...
	public ResponseEntity<CustomerDTO> update(@PathVariable long id, @RequestBody CustomerDTO dto) {
		...
		return ResponseEntity.ok().body(dto); // msg 200
	}
	
	@DeleteMapping(value = "/{id}")
	public ResponseEntity<CustomerDTO> delete(@PathVariable Long id) {
		service.delete(id);
		return ResponseEntity.noContent().build(); // msg 204
	}
